...
class MemeGenerator extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  componentDidMount() {
    fetch("https://api.imgflip.com/get_memes").then(response => response.json).then(response => console.log(response) // this.setState({
    // })
    );
  }
...
//# sourceMappingURL=main.6cb58bfac09032a547f5.hot-update.js.map