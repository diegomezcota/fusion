...
class MemeGenerator extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  componentDidMount() {
    fetch("https://api.imgflip.com/get_memes").then(response => response.json).then(response => console.log(response.data) // this.setState({
    // })
    );
  }
...
//# sourceMappingURL=main.3471adbaae167a6188cf.hot-update.js.map